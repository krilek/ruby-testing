...
RSpec.describe Grep do
  ...
  describe '#grep' do
    context 'when multiple files' do
      ...
      it 'several matches without flags' do
        pattern = 'may'
        flags = []
        files = ['iliad.txt', 'midsummer-night.txt', 'paradise-lost.txt']
      ...
      it 'several matches print line numbers flag' do
        pattern = 'that'
        flags = ['-n']
        files = ['iliad.txt', 'midsummer-night.txt', 'paradise-lost.txt']
      ...
      it 'one match print file names flag' do
        pattern = 'who'
        flags = ['-l']
        files = ['iliad.txt', 'midsummer-night.txt', 'paradise-lost.txt']
        expected = "iliad.txt\nparadise-lost.txt\n".rstrip
      ...
      it 'several matches case insensitive flag' do
        pattern = 'TO'
        flags = ['-i']
        files = ['iliad.txt', 'midsummer-night.txt', 'paradise-lost.txt']
        expected = <<~eos
      ...
      it 'several matches inverted flag' do
        pattern = 'a'
        flags = ['-v']
        files = ['iliad.txt', 'midsummer-night.txt', 'paradise-lost.txt']
        expected = <<~eos
      ...
      it 'one match match entire lines flag' do
      ...
      it 'one match multiple flags' do
      ...
      it 'no matches various flags' do
        pattern = 'Frodo'
        flags = ['-n', '-l', '-x', '-i']
        files = ['iliad.txt', 'midsummer-night.txt', 'paradise-lost.txt']
        expected = "\n".rstrip
      ...
      it 'several matches file flag takes precedence over line number flag' do
        pattern = 'who'
        flags = ['-n', '-l']
        files = ['iliad.txt', 'midsummer-night.txt', 'paradise-lost.txt']
        expected = "iliad.txt\nparadise-lost.txt\n".rstrip
      ...
      it 'several matches inverted and match entire lines flags' do
    ...
    context 'when single file' do
      ...
      it 'one match print line numbers flag' do
        pattern = 'Forbidden'
        flags = ['-n']
      ...
      it 'one match case insensitive flag' do
        pattern = 'FORBIDDEN'
        flags = ['-i']
        files = ['paradise-lost.txt']
      ...
      it 'several matches match entire lines flag' do
        pattern = 'may'
        flags = ['-x']
        files = ['midsummer-night.txt']
        expected = "\n".rstrip
      ...
      it 'one match file flag takes precedence over line flag' do
        pattern = 'ten'
        flags = ['-n', '-l']
        files = ['iliad.txt']
        expected = "iliad.txt\n".rstrip
